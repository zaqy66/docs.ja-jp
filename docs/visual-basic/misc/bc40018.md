...
---
# <a name="member-ltmembername1gt-implicitly-declares-ltimplicitmembernamegt-which-conflicts-with-a-member-implicitly-declared-for-member-ltmembername2gt-in-the-base-class-ltbaseclassnamegt"></a>メンバー '&lt;membername1&gt;'を暗黙的に宣言'&lt;implicitmembername&gt;'、メンバーのメンバーと競合するが暗黙的に宣言された'&lt;membername2&gt;'in 'の基本クラス&lt;baseclassname&gt;'
