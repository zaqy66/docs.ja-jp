...
---
# <a name="ltelementnamegt-is-ambiguous-because-multiple-kinds-of-members-with-this-name-exist-in-lttypegt-lttypenamegt"></a>'&lt;elementname&gt;' が、この名前を持つメンバーが多種類存在するため、あいまいな&lt;型&gt;'&lt;typename&gt;'
