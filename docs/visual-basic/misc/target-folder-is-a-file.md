...
- [ファイル、ディレクトリ、および Visual Basic でドライブのプロパティ](https://msdn.microsoft.com/library/131593e9-d1b0-4c89-9c03-ae8afc458829)
- [方法: Visual Basic でファイルの絶対パスを確認します。](https://msdn.microsoft.com/library/4c6769df-e9b9-4b69-bfdf-ce4cfbda30ff)
