...
---
# <a name="option-strict-on-does-not-allow-narrowing-in-implicit-type-conversions-between-method-ltmethodnamegt-and-delegate-ltdelegatenamegt"></a>Option strict On ではできませんメソッド間の暗黙的な型変換で縮小変換 '&lt;methodname&gt;'とデリゲート'&lt;delegatename&gt;'
