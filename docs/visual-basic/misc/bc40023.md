...
---
# <a name="member-ltmembername1gt-conflicts-with-a-member-implicitly-declared-for-member-ltmembername2gt-in-the-base-type-ltbasetypenamegt-and-so-should-not-be-declared-overloads"></a>メンバー '&lt;membername1&gt;'メンバーと競合はメンバーに対して暗黙的に宣言された'&lt;membername2&gt;'、'基本データ型&lt;basetypename&gt;'と宣言されていない必要がありますので'オーバー ロード
