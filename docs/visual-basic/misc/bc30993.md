...
---
# <a name="property-ltpropertynamegt-cannot-be-initialized-in-an-object-initializer-expression-because-all-accessible-overloads-require-arguments"></a>プロパティ '&lt;propertyname&gt;' すべてのアクセス可能なオーバー ロードは引数を必要とするために、オブジェクト初期化子式で初期化できません
