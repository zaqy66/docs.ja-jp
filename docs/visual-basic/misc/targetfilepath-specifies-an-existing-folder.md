...
## <a name="see-also"></a>関連項目  
 ...
 [方法: Visual Basic でディレクトリを移動](https://msdn.microsoft.com/library/0f26d1ef-c0a0-4445-8eb0-9b7d0490411c)  
 [方法: ファイルの名前を変更する](../../visual-basic/developing-apps/programming/drives-directories-files/how-to-rename-a-file.md)  
 [方法: Visual Basic でディレクトリの名前を変更](https://msdn.microsoft.com/library/780c7afc-a03c-4b01-865a-510fe331b1cc)
