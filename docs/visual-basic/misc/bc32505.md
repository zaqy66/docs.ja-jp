...
---
# <a name="systemruntimeinteropservicesdispidattribute-value-cannot-be-applied-to-lttypenamegt-because-microsoftvisualbasiccomclassattribute-reserves-zero-for-the-default-property"></a>'System.runtime.interopservices.dispidattribute' 値を適用できません '&lt;typename&gt;' の 'microsoft.visualbasic.comclassattribute' は、既定のプロパティに対して 0 を予約するため、
