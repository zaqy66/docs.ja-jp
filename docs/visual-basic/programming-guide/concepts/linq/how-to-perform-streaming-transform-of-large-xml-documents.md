...
## <a name="example"></a>例  
 次の例は例では、[方法: ヘッダー情報 (Visual Basic) にアクセスして XML フラグメントを Stream](../../../../visual-basic/programming-guide/concepts/linq/how-to-stream-xml-fragments-with-access-to-header-information.md)します。  
...
## <a name="example"></a>例  
 次の例は、例でもビルド[方法: ヘッダー情報 (Visual Basic) にアクセスして XML フラグメントを Stream](../../../../visual-basic/programming-guide/concepts/linq/how-to-stream-xml-fragments-with-access-to-header-information.md)します。  
