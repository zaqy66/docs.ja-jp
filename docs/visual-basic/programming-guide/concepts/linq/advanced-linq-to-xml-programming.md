...
|[方法: 大きな XML ドキュメント (Visual Basic) のストリーミング変換を実行](../../../../visual-basic/programming-guide/concepts/linq/how-to-perform-streaming-transform-of-large-xml-documents.md)|<xref:System.Xml.XmlReader> から XML をストリーム出力し、XML フラグメントを変換して、<xref:System.Xml.Linq.XStreamingElement> によってその出力をストリームする方法について説明します。|  
