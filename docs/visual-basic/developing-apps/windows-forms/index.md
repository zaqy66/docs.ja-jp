...
|終了|解決方法については、|  
|--------|---------|  
|Visual Studio で新しい Windows フォーム アプリケーションを作成します。|[チュートリアル: 単純な Windows フォームの作成](http://msdn.microsoft.com/library/2d9daec0-0543-41d0-acb1-964f685bddbb)|  
