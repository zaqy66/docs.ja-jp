...
- `struct` の宣言で、`ref struct` または `ref readonly struct` を宣言します。 詳しくは、「[ref struct 宣言](#ref-struct-declarations)」をご覧ください。
...
## <a name="ref-struct-declarations"></a>ref struct 宣言
