...
認識できないエスケープ シーケンスです  
 ...
 予期しない文字は [文字列](../../../csharp/language-reference/keywords/string.md)の円記号 (\\) に従います。 コンパイラは、有効なエスケープ文字のうち 1 つを要求します。 詳細については、「 [Character Escapes](../../../standard/base-types/character-escapes-in-regular-expressions.md)」を参照してください。  
