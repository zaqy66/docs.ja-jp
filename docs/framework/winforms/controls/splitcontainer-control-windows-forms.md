...
> [!NOTE]
>  **ツールボックス**、この置換を制御、 <xref:System.Windows.Forms.Splitter> Visual Studio の以前のバージョンであるコントロール。 `SplitContainer` コントロールは <xref:System.Windows.Forms.Splitter> コントロールより優先されます。 <xref:System.Windows.Forms.Splitter> クラスは、既存のアプリケーションの互換性のために .NET Framework に含まれていますが、新しいプロジェクトでは `SplitContainer` コントロールを使用することを強くお勧めします。  
...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 参照してください[方法: 分割ウィンドウ水平方向を使用して、デザイナー](how-to-split-a-window-horizontally-using-the-designer.md)、[方法: Windows フォームで Windows エクスプ ローラー スタイルのインターフェイスを作成する](https://msdn.microsoft.com/library/zh2fe5a5\(v=vs.110\))、[方法: Multipane ユーザー インターフェイスを作成デザイナーを使用して Windows フォーム](create-a-multipane-user-interface-with-wf-using-the-designer.md)します。  
