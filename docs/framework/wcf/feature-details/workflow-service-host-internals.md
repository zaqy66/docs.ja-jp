...
## <a name="workflowservicehost-details"></a>WorkflowServiceHost の詳細  
 ...
 ![WorkflowServiceHost がメッセージを受信](../../../../docs/framework/wcf/feature-details/media/wfshreceivemessage.gif "WFSHReceiveMessage")  
