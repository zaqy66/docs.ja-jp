...
```
 ...
 <span data-ttu-id="e8459-169">サービスを起動すると、再送信されたメッセージが読み取られて処理されます。</span><span class="sxs-lookup"><span data-stu-id="e8459-169">The service starts and then reads the resent message and processes it.</span></span>
