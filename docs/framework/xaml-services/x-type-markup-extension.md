...
## <a name="xaml-values"></a><span data-ttu-id="3b9da-106">XAML 値</span><span class="sxs-lookup"><span data-stu-id="3b9da-106">XAML Values</span></span>  
