...
## <a name="translation-transformations"></a>平行移動変換  
 ...
 ![平行移動の図](../../../../docs/framework/wpf/graphics-multimedia/media/transforms-translate.png "変換の変換")  
オフセットでの平行移動  
...
ScaleVector の例  
 ...
 ![指定した中心点で 3 つのキューブがスケールされる](../../../../docs/framework/wpf/graphics-multimedia/media/threecubes-scaledwithcenter-1.png "threecubes_scaledwithcenter_1")  
スケールの中心点の例  
