...
> [!NOTE]
>  <xref:System.Windows.Documents.TableCell> 要素は、テキスト コンテンツを直接ホストしない可能性があります。 コンテンツ要素などのフローのコンテインメイト規則の詳細については<xref:System.Windows.Documents.TableCell>を参照してください[フロー ドキュメントの概要](../../../../docs/framework/wpf/advanced/flow-document-overview.md)します。  
...
>  <xref:System.Windows.Documents.Table> ような<xref:System.Windows.Controls.Grid>要素が、その他の機能があり、そのため、大きいリソースのオーバーヘッドが必要です。  
 ...
 ![スクリーン ショット:基本的なテーブル](../../../../docs/framework/wpf/advanced/media/basictablerrender.png "BasicTablerRender")  
...
### <a name="row-groupings"></a>行グループ  
 ...
 ![スクリーン ショット:テーブルの行グループ](../../../../docs/framework/wpf/advanced/media/table-rowgroups.png "Table_RowGroups")  
...
5.  <xref:System.Windows.Documents.TableCell>  
 ...
 ![スクリーン ショット:テーブル z&#45;順序](../../../../docs/framework/wpf/advanced/media/table-zorder.png "Table_ZOrder")  
...
### <a name="spanning-rows-or-columns"></a>複数の行または列にまたがるセル  
 ...
 ![スクリーン ショット:次の 3 つのすべての列にまたがるセル](../../../../docs/framework/wpf/advanced/media/table-columnspan.png "Table_ColumnSpan")  
