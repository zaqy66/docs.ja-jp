...
### <a name="creating-the-sql-server-table"></a><span data-ttu-id="ca514-114">SQL Server テーブルの作成</span><span class="sxs-lookup"><span data-stu-id="ca514-114">Creating the SQL Server Table</span></span>  
