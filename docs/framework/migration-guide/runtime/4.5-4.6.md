...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-46"></a><span data-ttu-id="80923-102">.NET Framework 4.5 から 4.6 への移行に関するランタイム変更</span><span class="sxs-lookup"><span data-stu-id="80923-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="80923-103">.NET Framework 4.5 から 4.6 に移行する場合は、アプリに影響する可能性があるアプリケーションの互換性の問題に関する次のトピックを確認してください。</span><span class="sxs-lookup"><span data-stu-id="80923-103">If you are migrating from the .NET Framework 4.5 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="80923-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="80923-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="80923-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="80923-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="80923-106">コア</span><span class="sxs-lookup"><span data-stu-id="80923-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="80923-107">データ</span><span class="sxs-lookup"><span data-stu-id="80923-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="80923-108">デバッガー</span><span class="sxs-lookup"><span data-stu-id="80923-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="80923-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="80923-109">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="80923-110">ネットワーキング</span><span class="sxs-lookup"><span data-stu-id="80923-110">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="80923-111">シリアル化</span><span class="sxs-lookup"><span data-stu-id="80923-111">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="80923-112">セットアップと配置</span><span class="sxs-lookup"><span data-stu-id="80923-112">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="80923-113">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="80923-113">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="80923-114">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="80923-114">Windows Presentation Foundation (WPF)</span></span>
