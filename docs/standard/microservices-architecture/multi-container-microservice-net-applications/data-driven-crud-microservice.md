...
現時点では、Swashbuckle は、ASP.NET Core アプリケーション用の [Swashbuckle.AspNetCore](https://www.nuget.org/packages/Swashbuckle.AspNetCore/) バージョン 1.0.0 以降の高レベルのメタ パッケージ下の複数の内部 NuGet パッケージから構成されます。
