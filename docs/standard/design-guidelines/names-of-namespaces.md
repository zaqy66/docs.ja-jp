 ...
 **✓ DO** をピリオド pascal 表記を使用、および別の名前空間のコンポーネントを使用して (例: `Microsoft.Office.PowerPoint`)。 会社をブランド化は、従来とは異なる大文字と小文字を使用している場合は、標準の名前空間の大文字と小文字から以上逸脱している場合でも、ブランド名で定義されている大文字小文字の区別に従ってください。  
